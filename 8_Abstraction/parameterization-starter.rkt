...
;; produce list of results of fn applied on every number in lon
...
(check-expect (map2 abs (list -2 -4)) (list 2 4))
(check-expect (map2 string-length (list "hello" "world")) (list 5 5))
